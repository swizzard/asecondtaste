...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Menu._Menu__period'
        db.add_column(u'dishes_menu', '_Menu__period',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MenuItem._MenuItem__formatted_price'
        db.add_column(u'dishes_menuitem', '_MenuItem__formatted_price',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, db_column='formatted_price', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Menu._Menu__period'
        db.delete_column(u'dishes_menu', '_Menu__period')

        # Deleting field 'MenuItem._MenuItem__formatted_price'
        db.delete_column(u'dishes_menuitem', 'formatted_price')
    ...
    models = {
        ...
        u'dishes.menu': {
            ...
            '_Menu__period': ('django.db.models.fields.CharField', [], {'max_length': '9', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dishes.menuitem': {
            ...
            '_MenuItem__formatted_price': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'db_column': "'formatted_price'", 'blank': 'True'}),
