...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Menu._Menu__period' to match new field type.
        db.rename_column(u'dishes_menu', '_Menu__period', 'period')
        # Changing field 'Menu._Menu__period'
        db.alter_column(u'dishes_menu', 'period', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, db_column='period'))

    def backwards(self, orm):

        # Renaming column for 'Menu._Menu__period' to match new field type.
        db.rename_column(u'dishes_menu', 'period', '_Menu__period')
        # Changing field 'Menu._Menu__period'
        db.alter_column(u'dishes_menu', '_Menu__period', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))
