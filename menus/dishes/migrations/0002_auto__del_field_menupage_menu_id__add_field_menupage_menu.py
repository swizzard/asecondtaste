...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MenuPage.menu_id'
        db.delete_column(u'dishes_menupage', 'menu_id_id')

        # Adding field 'MenuPage.menu'
        db.add_column(u'dishes_menupage', 'menu',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dishes.Menu'], to_field='mk', null=True, unique=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MenuPage.menu_id'
        db.add_column(u'dishes_menupage', 'menu_id',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dishes.Menu'], to_field='mk', null=True, unique=True, blank=True),
                      keep_default=False)

        # Deleting field 'MenuPage.menu'
        db.delete_column(u'dishes_menupage', 'menu_id')
    ...
    models = {
        ...
        u'dishes.menupage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dishes.Menu']", 'to_field': "'mk'", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'mk': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        }
    }
